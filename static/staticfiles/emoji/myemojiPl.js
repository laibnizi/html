	...
	$.fn.myEmoji = function(options) {
		var defaults = {
			emojiconfig: {
				tieba: {
					name: "贴表情",
					path: "../staticfiles/emoji/img/tieba/",
					maxNum: 50,
					file: ".jpg",
					placeholder: ":{alias}:",
					alias: {
					...
					title: {
				 	...
				 	name: "",
                    path: "../staticfiles/emoji/img/AcFun/",
				 	maxNum: 54,
				 	file: ".png"
				 },
                QQ: {
                    name: "QQ",
                    path: "../staticfiles/emoji/img/qq/",
                    maxNum: 54,
                    file: ".gif"
                }
			}
		...
		var emjio = InputFoot.find('#emjio');
		...
		InputFoot.find('.postBtn').on('click');
